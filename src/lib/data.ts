...
export const SERVICES: Service[] = [
  ...
  { id: 's2', name: 'Taglio Uomo', description: 'Taglio classico o moderno con finitura', price: 30, duration: 30, category: 'taglio', image: 'https://images.unsplash.com/photo-1621605815971-fbc98d66507f?w=400&q=80' },
  ...
  { id: 's5', name: 'Piega', description: 'Piega e styling con phon e spazzola', price: 35, duration: 30, category: 'styling', image: 'https://images.unsplash.com/photo-1527799820374-dcf8d570d2b1?w=400&q=80' },
  ...
  { id: 's9', name: 'Pedicure', description: 'Trattamento completo piedi con relax', price: 45, duration: 60, category: 'unghie', image: 'https://images.unsplash.com/photo-1511174511562-5f7f9b8f8b8a?w=400&q=80' },
...
export const PRODUCTS: Product[] = [
  { id: 'p1', name: 'Shampoo Nutriente 300ml', description: 'Shampoo delicato per capelli secchi e danneggiati', price: 18, image: 'https://images.unsplash.com/photo-1631729371254-42c2892f0e6e?w=400&q=80', category: 'capelli', inStock: true, stock: 12, threshold: 5 },
  { id: 'p2', name: 'Balsamo Morbidezza 300ml', description: 'Balsamo districante con cheratina', price: 20, image: 'https://images.unsplash.com/photo-1585386959984-a4155224a1ad?w=400&q=80', category: 'capelli', inStock: true, stock: 8, threshold: 5 },
  { id: 'p3', name: 'Maschera Rivitalizzante 200ml', description: 'Maschera rigenerante con oli naturali', price: 28, image: 'https://images.unsplash.com/photo-1611930022073-b7a4ba5fcccd?w=400&q=80', category: 'capelli', inStock: true, stock: 6, threshold: 3 },
  { id: 'p4', name: 'Olio Capelli 50ml', description: 'Olio leggero per lucentezza e protezione termica', price: 22, image: 'https://images.unsplash.com/photo-1617897903246-719242758050?w=400&q=80', category: 'capelli', inStock: true, stock: 15, threshold: 5 },
  { id: 'p5', name: 'Spazzola Professionale', description: 'Spazzola termica in setole naturali', price: 25, image: 'https://images.unsplash.com/photo-1619621726078-31e2904a9f40?w=400&q=80', category: 'accessori', inStock: true, stock: 4, threshold: 3 },
  { id: 'p6', name: 'Fon Professionale 2200W', description: 'Asciugacapelli professionale con diffusore', price: 89, image: 'https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?w=400&q=80', category: 'accessori', inStock: false, stock: 0, threshold: 2 },
  { id: 'p7', name: 'Set Pettini', description: 'Set 3 pettini professionali anti-stattica', price: 12, image: 'https://images.unsplash.com/photo-1596018191454-d2b10b77c3b0?w=400&q=80', category: 'accessori', inStock: true, stock: 20, threshold: 5 },
  { id: 'p8', name: 'Cera Modellante 100ml', description: 'Cera per capelli a tenuta forte', price: 15, image: 'https://images.unsplash.com/photo-1620916566398-39f1143ab7be?w=400&q=80', category: 'styling', inStock: true, stock: 9, threshold: 5 },
  { id: 'p9', name: 'Lacca Capelli 300ml', description: 'Lacca a tenuta extra forte', price: 14, image: 'https://images.unsplash.com/photo-1620916566398-39f1143ab7be?w=400&q=80', category: 'styling', inStock: true, stock: 3, threshold: 5 },
  { id: 'p10', name: 'Crema Mani 75ml', description: 'Crema mani idratante alla calendula', price: 10, image: 'https://images.unsplash.com/photo-1611930022073-b7a4ba5fcccd?w=400&q=80', category: 'corpo', inStock: true, stock: 25, threshold: 5 },
  { id: 'p11', name: 'Smalto Semipermanente', description: 'Smalto gel effetto glossy 15ml', price: 16, image: 'https://images.unsplash.com/photo-1607779097040-26e80aa78e66?w=400&q=80', category: 'unghie', inStock: true, stock: 7, threshold: 5 },
  { id: 'p12', name: 'Buono Regalo', description: 'Buono regalo da 50€ utilizzabile su tutti i servizi', price: 50, image: 'https://images.unsplash.com/photo-1549465220-1a8b9238cd48?w=400&q=80', category: 'regali', inStock: true, stock: 50, threshold: 10 },
]
